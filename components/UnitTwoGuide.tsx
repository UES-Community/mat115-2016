...
import { CheckCircle2, Infinity, LineChart } from 'lucide-react';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/ui/accordion';
import MathRender from './MathRender';

const topics = [
  { id: 'introduccion', number: '01', title: 'Introducción a los límites', objective: 'Describe el valor al que se aproxima una función cuando x se acerca a un punto.', formula: '\\lim_{x \\to a} f(x) = L', example: 'Aunque f(a) no exista, el límite puede existir si los valores cercanos se aproximan a L.' },
